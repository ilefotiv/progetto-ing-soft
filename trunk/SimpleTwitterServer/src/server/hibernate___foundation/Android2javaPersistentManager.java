...
public class Android2javaPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Android2java";
	...
	private Android2javaPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new Android2javaPersistentManager();
		}
